...
!function(){"use strict";var e=function(e,o,a){try{var t=e.geometry.location.A,n=e.geometry.location.F;return new google.maps.LatLng(t,n)}catch(s){return new google.maps.LatLng(o.lat,o.lng)}};angular.module("ngPlacesMap",[]).filter("gps",function(){return function(e,o){var a;try{a=JSON.parse(e)}catch(t){a=!1}return a&&a[o]?a[o]:""}}).directive("placesMap",function(){return{restrict:"E",replace:!0,scope:{customCallback:"&?",picked:"=?",address:"=?",fallback:"=?",mapType:"@?",readonly:"@?",responsive:"@?",draggable:"@?",toggleMapDraggable:"=?",placeNotFound:"=?",updateMarkerLabel:"=?",redrawMap:"=?",mapOptions:"=?","static":"@"},controller:["$scope",function(e){}],template:'<div class="dp-places-map-wrapper"><input type="text" class="dp-places-map-input"><div class="dp-places-map-canvas"></div></div>',link:function(o,a,t,n){var s="true"==o.draggable;o.toggleMapDraggable=function(e){s=e,p.setOptions({draggable:s,scrollwheel:s})},o.updateMarkerLabel=function(e){y.setContent(e)},o.redrawMap&&(o.redrawMap.updateMap=function(e){var o=new google.maps.LatLng(e.lat,e.lng);_(o,!1,!1),p.setCenter(o)});var r;r=o["static"]&&"true"==o["static"]?{zoom:5,draggable:!1,panControl:!1,zoomControl:!1,scrollwheel:!1,mapTypeControl:!1,streetViewControl:!1,clickableIcons:!1}:{zoom:5};var l=angular.extend(r,o.mapOptions),c={};o.address&&(c=o.address,l.zoom=o.address.zoom||15);var i={};i.lat=41.87194,i.lng=12.567379999999957,o.fallback&&(i=o.fallback,l.zoom=o.fallback.zoom||l.zoom),o.draggable&&"false"==o.draggable&&(l.draggable=!1,l.scrollwheel=!1),o.mapType&&google.maps.MapTypeId[o.mapType]&&(l.mapTypeId=google.maps.MapTypeId[o.mapType]),l.center=e(c,i);var g=a.find("div")[0],d=a.find("input")[0];o.responsive&&"true"==o.responsive&&(g.className+=" responsive");var p=new google.maps.Map(g,l),m=new google.maps.places.PlacesService(p),u=new google.maps.Geocoder,v=new google.maps.Marker({map:p,anchorPoint:new google.maps.Point(0,(-29))}),y=new google.maps.InfoWindow;o.readonly?d.style.display="none":p.controls[google.maps.ControlPosition.TOP_LEFT].push(d);var f=new google.maps.places.Autocomplete(d);f.bindTo("bounds",p);var w=function(e,a,t){if(!e.geometry)return void("function"==typeof o.placeNotFound?o.placeNotFound():alert("Pick a valid location"));e.geometry.viewport?p.fitBounds(e.geometry.viewport):(p.setCenter(e.geometry.location),p.setZoom(o.address&&o.address.zoom?o.address.zoom:15)),v.setIcon({url:e.icon,size:new google.maps.Size(71,71),origin:new google.maps.Point(0,0),anchor:new google.maps.Point(17,34),scaledSize:new google.maps.Size(35,35)});var n="",s="";a?(s=a,e.geometry.address=c,e.formatted_address=c):(e.address_components&&(n=[e.address_components[0]&&e.address_components[0].short_name||"",e.address_components[1]&&e.address_components[1].short_name||"",e.address_components[2]&&e.address_components[2].short_name||""].join(" ")),""!==n&&(s="<div><strong>"+e.name+"</strong><br>"+n+"</div>")),b(e.geometry.location,s,e,t)},_=function(e,o,a){var t=new google.maps.LatLng(e.lat(),e.lng());y.close();var n={};n.place_id=null,n.geometry={},n.geometry.location={A:e.lat(),F:e.lng()};var s="";o?(s=o,n.geometry.address=c,n.formatted_address=c,b(e,s,n,a)):u.geocode({location:t},function(o,t){var r="";t===google.maps.GeocoderStatus.OK&&o[0]&&o[0].address_components&&(r=[o[0].address_components[0]&&o[0].address_components[0].short_name||"",o[0].address_components[1]&&o[0].address_components[1].short_name||"",o[0].address_components[2]&&o[0].address_components[2].short_name||""].join(" ")),""!==r?s="<div><strong>"+r+"</strong></div>":r=e.lat()+", "+e.lng(),n.geometry.address=r,n.formatted_address=r,v.setPosition(e),v.setVisible(!0),b(e,s,n,a)})},b=function(e,a,t,n){y.close(),v.setVisible(!1),""!==a&&(y.setContent(a),y.open(p,v)),v.setPosition(e),v.setVisible(!0),o.picked=t,t.geometry.location.lat&&"function"==typeof t.geometry.location.lat||(t.geometry.location.lat=function(){return t.geometry.location.A}),t.geometry.location.lng&&"function"==typeof t.geometry.location.lng||(t.geometry.location.lng=function(){return t.geometry.location.F}),n&&o.customCallback({pickedPlace:t}),o.$apply()},L=function(){y.close(),v.setVisible(!1);var e=f.getPlace();w(e,null,!0)};if(c.place_id)m.getDetails({placeId:c.place_id},function(e,o){o===google.maps.places.PlacesServiceStatus.OK&&w(e,c.address,!1)});else if(c.hasOwnProperty("geometry")){var h=new google.maps.LatLng(c.geometry.location.A,c.geometry.location.F);u.geocode({location:h},function(e,o){o===google.maps.GeocoderStatus.OK&&_(e[0].geometry.location,c.address,!1)})}google.maps.event.addListener(f,"place_changed",L),google.maps.event.addDomListener(window,"resize",function(){var e=p.getCenter();google.maps.event.trigger(p,"resize"),p.setCenter(e)}),google.maps.event.addListener(p,"click",function(e){s&&_(e.latLng,null,!0)})}}})}();